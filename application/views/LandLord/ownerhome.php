      ...
      <div class="row">
        ...
        <div class="col-md-9">
            ...
            <div class="panel-body">
              <div class="col-md-3">
                <div class="well dash-box">
                  <h2><span class="glyphicon glyphicon-stats"></span> 140</h2>
                  <h4>No. of Lands</h4>
                </div>
              </div>
              <div class="col-md-3 dash-box">
                <div class="well">
                  <h2><span class="glyphicon glyphicon-grain"></span> 18</h2>
                  <h4>Lands</h4>
                </div>
              </div>
         ...
         <div class="panel panel-default animated zoomIn">
            ...
            <div class="panel-heading main-color-bg">Land Lords</div>
            <div class="panel-body">
              <!-- Table -->
